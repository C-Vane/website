          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 mb-6 px-4 py-1.5 rounded-full bg-surface border border-border text-sm text-slate-400">
                ...
                <span>Software house · Estonia-registered · Operating globally</span>
              </div>
              ...
              <p className="mt-6 text-lg text-slate-400 max-w-lg leading-relaxed">
                We build software on demand, place skilled engineers in your team, and
                optimise your digital presence  -  all under one roof.
              </p>
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-slate-400 max-w-xl mx-auto">
              From the first line of code to the right hire  -  we cover the full spectrum.
            </p>
          </div>
      ...
      <section className="relative h-64 md:h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-6">
            ...
            <p className="mt-3 text-slate-400 text-sm">Vanessa Cattabiani, Founder</p>
          </div>
        </div>
      </section>
